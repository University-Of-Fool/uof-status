  ...
  constructor(path: string) {
    ...
    this.config = {
      ...
      Logging: {
        Api: {
          ...
          filename:
            configObj.Logging.Api.filename || __dirname + "/logs/api.log",
        },
        Db: {
        ...
        App: {
          ...
          filename:
            configObj.Logging.App.filename || __dirname + "/logs/app.log",
        },
        Timer: {
          ...
          filename:
            configObj.Logging.Timer.filename || __dirname + "/logs/timer.log",
        },
      },
      Timer: {
    ...
    log4js.configure({
      ...
      categories: {
        ...
        timer: {
          appenders: this.genAppender(this.config.Logging.Timer, "timer"),
